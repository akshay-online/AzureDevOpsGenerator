        ...
        public string GetRepositoryToDelete(string project)
        {
            try
            {
                ...
                using (var client = GetHttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        viewModel = response.Content.ReadFromJsonAsync<GetAllRepositoriesResponse.Repositories>().Result;
            ...
            try
            {
                ...
                using (var client = GetHttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        // Replace all occurrences of ReadAsAsync with ReadFromJsonAsync
                        viewModel = response.Content.ReadFromJsonAsync<GetAllRepositoriesResponse.Repositories>().Result;
